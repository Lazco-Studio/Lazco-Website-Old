export default function Top() {
  return (
    <div className="relative top h-[640px]">
      ...
      <div className="absolute inset-0 p-2 content h-full max-w-[640px] m-auto flex flex-col justify-center items-start text-center	 max-[600px]:items-center	ml-10">
